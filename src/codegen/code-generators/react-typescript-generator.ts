  ...
  private generateAccessorMethods(): string[] {
    ...
    const schemaTypes = this.filteredConfigurations().map((config) => {
      ...
      if (config.hasFunction) {
        ...
        return stripIndent`
          ${methodName}(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['${config.key}'] {
      ...
      return stripIndent`
        get ${methodName}(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['${config.key}'] {
