  ...
  describe('declarationGenerate', () => {
    it('should generate basic code structure when no configs exist', () => {
      ...
      declare module "@reforge-com/react" {
        import { Reforge, ContextAttributes, SharedSettings, ReforgeTypesafeClass } from "@reforge-com/react";
        ...
        export function useReforge(): {
          loading: boolean;
          get<K extends keyof ReactHookConfigurationRaw>(
            key: K,
          ): ReactHookConfigurationRaw[K];
        };

        export type ReforgeProviderProps = SharedSettings & {
          apiKey: string;
          contextAttributes?: ContextAttributes;
          ReforgeTypesafeClass?: ReforgeTypesafeClass<unknown>;
        };

        export const ReforgeProvider: React.ComponentType<ReforgeProviderProps>;

        export function createReforgeHook<
          T extends new (reforge: Reforge) => unknown,
        >(
          _typesafeClass: T,
        ): () => {
          loading: boolean;
  ...
  describe('generate', () => {
    it('should generate basic code structure when no configs exist', () => {
      ...
      export class ReforgeTypesafeReact {
        ...
        get<K extends keyof ReforgeTypeGeneration.ReactHookConfigurationRaw>(key: K): ReforgeTypeGeneration.ReactHookConfigurationRaw[K] {
          return this.reforge.get(key) as ReforgeTypeGeneration.ReactHookConfigurationRaw[K]
        }
    ...
    it('should generate type definitions for configs and feature flags, not schema, empty configurations, or non-client configs', () => {
      ...
      export class ReforgeTypesafeReact {
        ...
        get config1(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['config1'] {
    ...
    it('should generate function accessor methods for function configs', () => {
      ...
      export class ReforgeTypesafeReact {
        ...
        config1(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['config1'] {
    ...
    it('should prefix method names with underscore when they start with a digit', () => {
      ...
      export class ReforgeTypesafeReact {
        ...
        get _1Config(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['1config'] {
    ...
    it('should properly camelCase various key formats', () => {
      ...
      export class ReforgeTypesafeReact {
        ...
        get dotNotationKey(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['dot.notation.key'] {
        ...
        get keyWithSpecial(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['key_with_$_special'] {
        ...
        get snakeCaseKey(): ReforgeTypeGeneration.ReactHookConfigurationAccessor['snake_case_key'] {
