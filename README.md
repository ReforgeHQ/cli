...
_See code: [src/commands/create.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/create.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/generate.ts)_
...
_See code: [src/commands/generate-new-hex-key.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/generate-new-hex-key.ts)_
...
_See code: [src/commands/info.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/info.ts)_
...
_See code: [src/commands/interactive.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/interactive.ts)_
...
_See code: [src/commands/schema.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/schema.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/ReforgeHQ/cli/blob/v0.0.0-pre.11/src/commands/serve.ts)_
